...
"""
    ...
    API we will use for detecting a face in an image,
    finding facial landmarks, and alignment given these landmarks.
"""
...
class AlignDlib:
    ...
    def __init__(self, facePredictor: str):
        """
    ...
    def getAllFaceBoundingBoxes(self, rgbImg) -> dlib.rectangles:
        """
    ...
    def getLargestFaceBoundingBox(self, rgbImg, skipMulti=False) -> dlib.rectangle:
        """
